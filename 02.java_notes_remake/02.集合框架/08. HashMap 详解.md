...
- [2. 底层数据结构分析](#2-底层数据结构分析)
  - [2.1. JDK1.8 之前](#21-jdk18-之前)
  - [2.2. JDK1.8 之后](#22-jdk18-之后)
- [3. HashMap 源码分析](#3-hashmap-源码分析)
  - [3.1. 构造方法](#31-构造方法)
  - [3.2. put 方法](#32-put-方法)
  - [3.3. get 方法](#33-get-方法)
  - [3.4. resize 方法](#34-resize-方法)
- [4. HashMap 常用方法测试](#4-hashmap-常用方法测试)
