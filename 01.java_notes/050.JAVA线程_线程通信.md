...
- [1. 线程通信](#1-线程通信)
  ...
  - [1.2. Object 类中的 wait 和 notify 方法](#12-object-类中的-wait-和-notify-方法)
    - [1.2.1. 通信流程](#121-通信流程)
    - [1.2.2. 消费者案例的线程通信版(交替生产和消费)](#122-消费者案例的线程通信版交替生产和消费)
  - [1.3. Lock和Condition接口](#13-lock和condition接口)
...
### 1.2. Object 类中的 wait 和 notify 方法
